...
title('Orientation Test: X-Axis Accelerometer Data')
...
title('Orientation Test: Y-Axis Accelerometer Data')
...
title('Orientation Test: Z-Axis Accelerometer Data')
...
title('Orientation Test: X-Axis Gyroscope Data')
...
title('Orientation Test: Y-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Orientation Test: Z-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
plot(time_ornt, AcX2_ornt, 'b-')
% plot(time_ornt, AcX_ornt, 'r-')
title('Orientation Test: Corrected X-Axis Acceleration')
ylabel('X-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Orientation Test: Corrected Y-Axis Acceleration')
ylabel('Y-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Orientation Test: Corrected Z-Axis Acceleration')
ylabel('Z-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
plot(time_ornt, GyX2_ornt, 'b-')
% plot(time_ornt, GyX_ornt, 'r-')
title('Orientation Test: Corrected X-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Orientation Test: Corrected Y-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Orientation Test: Corrected Z-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Calculated Roll Angle from Raw Data')
...
title('Calculated Pitch Angle from Raw Data')
...
title('Calculated Roll Angle from Corrected Data')
ylabel('Roll Angle (deg)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Calculated Pitch Angle from Corrected Data')
ylabel('Pitch Angle (deg)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','location','best')
xlim([0,150])
...
title('Static Test: X-Axis Accelerometer Data')
ylabel('X-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
...
title('Static Test: Y-Axis Accelerometer Data')
ylabel('Y-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Z-Axis Accelerometer Data')
ylabel('Z-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: X-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Y-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Z-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
plot(time_stat, AcX2_stat, 'b-')
plot(time_stat, AcX_stat, 'r-')
title('Static Test: Corrected X-Axis Acceleration')
ylabel('X-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Corrected Y-Axis Acceleration')
ylabel('Y-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Corrected Z-Axis Acceleration')
ylabel('Z-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
plot(time_stat, GyX2_stat, 'b-')
plot(time_stat, GyX_stat, 'r-')
title('Static Test: Corrected X-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Corrected Y-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Static Test: Corrected Z-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
% field test 5
cd 'C:\Users\Vince\OneDrive - Loughborough University\1. University\4. Part C\Modules\FYP\Proj\Data Logger\Data\20200502 TEST 5'
dump5 = csvread('DATALOG.CSV') ;
data = dump5(115:2650,:) ;
filename = 'test5summary.csv' ;
...
title('Field Test: X-Axis Accelerometer Data')
ylabel('X-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
xlim([225,270])
...
title('Field Test: Y-Axis Accelerometer Data')
ylabel('Y-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Z-Axis Accelerometer Data')
ylabel('Z-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: X-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Y-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Z-Axis Gyroscope Data')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected X-Axis Acceleration')
ylabel('X-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected Y-Axis Acceleration')
ylabel('Y-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected Z-Axis Acceleration')
ylabel('Z-Axis Acceleration (m/s^2)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected X-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected Y-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
title('Field Test: Corrected Z-Axis Angular Rate')
ylabel('Angular Rate (rad/s)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
% grid on
% grid minor
% plot(timestamp, rad2deg(phi_d1r), 'g-')
% plot(timestamp, rad2deg(phi_d2r), 'b-')
% % plot(timestamp, rad2deg(phi_dr), 'r-')
% title('Small Roll Angle Approximation from Raw Data')
...
% grid on
% grid minor
% plot(timestamp, rad2deg(phi_w1r), 'g-')
% plot(timestamp, rad2deg(phi_w2r), 'b-')
% % plot(timestamp, rad2deg(phi_wr), 'r-')
% title('Large Roll Angle Approximation from Raw Data')
% ylabel('Roll Angle (rad)')
% xlabel('Time Stamp (seconds)')
% legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
% xlim([225,270])
...
grid on
grid minor
plot(timestamp, rad2deg(phi_d1c), 'g-')
plot(timestamp, rad2deg(phi_d2c), 'b-')
% plot(timestamp, rad2deg(phi_dc), 'r-')
...
grid on
grid minor
plot(timestamp, rad2deg(phi_w1c), 'g-')
plot(timestamp, rad2deg(phi_w2c), 'b-')
% plot(timestamp, rad2deg(phi_wc), 'r-')
...
plot(timestamp, rad2deg(phi_d2c), 'b-')
% plot(timestamp, rad2deg(phi_dc), 'r-')
title('Small Roll Angle Approximation from Corrected Data')
ylabel('Roll Angle (rad)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
xlim([675,720])
...
plot(timestamp, rad2deg(phi_w2c), 'b-')
% plot(timestamp, rad2deg(phi_wc), 'r-')
title('Large Roll Angle Approximation from Corrected Data')
ylabel('Roll Angle (rad)')
xlabel('Time Stamp (seconds)')
legend('MPU1 Data','MPU2 Data','Fused Data','location','best')
xlim([675,720])
...
title('Blending Function - First Order Low Pass Filter Co-efficient, W')
...
savefig('Blending Co-efficient, W')
...
% 2) Compute Kalman gain (Kk)
    Kk_1 = (Pkp_1*H') / (H*Pkp_1*H' + R) ;
    Kk_2 = (Pkp_2*H') / (H*Pkp_2*H' + R) ;
    Kk_w = (Pkp_w*H') / (H*Pkp_w*H' + R) ;
...
grid minor
plot(timestamp, W, 'r-')
title('Variation of Blending Co-Efficient, W, for Corrected Real Data')
ylabel('Blending Co-efficient, W')
xlabel('Time Stamp (seconds)')
...
zero_roll = zeros(length(timestamp),1) ;
...
% plot(timestamp, rad2deg(xkp_2(1,:)), 'b-')
plot(timestamp, rad2deg(zk_w), 'r-')
plot(timestamp, rad2deg(xk_w(1,:)), 'b-')
plot(timestamp, zero_roll, 'k-')
title('Bicycle Roll Angle during Roundabouts on Lap 1')
...
plot(timestamp, rad2deg(xk_w(1,:)), 'b-')
plot(timestamp, zero_roll, 'k-')
title('Bicycle Roll Angle during Roundabouts on Lap 2')
ylabel('Roll Angle (degrees)')
xlabel('Time Stamp (seconds)')
legend('"Measurement"','Filter Estimate','location','best')
xlim([675,720])
